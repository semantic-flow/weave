import { WebInclusion, CopyStrategy } from "../../types.ts";
 ...
 */
export function processWebInclusion(inclusion: WebInclusion, _destDir: string, result: BuildResult, _globalCopyStrategy: CopyStrategy): void {
