...
- [ ] Fix later binary payload advancement as a dedicated end-to-end byte-preservation task: now cut as [[wa.task.2026.2026-08-01_1411-binary-payload-advancement]] (2026-08-01, code-verified draft — the r1 F3 decode path confirmed at `73a26cc`, plus an adjacent defect: later renderers hard-code `sflo:RdfDocument` onto binary payloads). Awaiting the five spec adjudications on the [[wa.dave-court]] card before it can queue.
