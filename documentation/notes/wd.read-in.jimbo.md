...
- **Append-only inventory migration is active** — the oversized legacy task was reclassified as [[wa.plan.2026.2026-05-17-append-onlyish-inventory]] on 2026-08-31 after a fresh writer audit. Add-reference plus batched and versioned-sequential extracted MeshInventory paths are delivered; [[wa.task.2026.2026-08-31_1050-current-only-payload-like-mesh-inventory-append]] is next.
