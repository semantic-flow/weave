...
- **Append-only inventory migration is ruling-bound** — add-reference, extracted/current-only MeshInventory, current-only PageDefinition, current-shape extract, and [[wa.completed.2026.2026-08-31_1219-mesh-support-page-only-inventory-append]] are delivered under [[wa.plan.2026.2026-05-17-append-onlyish-inventory]]. Named repository locators are ruled; [[wa.dave-court]] retains the exact source-registry fragment and legacy MeshInventory progression migration.
