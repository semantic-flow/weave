...
- **Append-only inventory migration is active** — the oversized legacy task was reclassified as [[wa.plan.2026.2026-05-17-append-onlyish-inventory]] on 2026-08-31 after a fresh writer audit. [[wa.completed.2026.2026-08-31_0106-add-reference-inventory-append]] removed the first live data-loss path in Weave PR #50; [[wa.task.2026.2026-08-31_0845-batched-extracted-mesh-inventory-append]] is next.
