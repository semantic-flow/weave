...
- The planning loop is LIVE and its infrastructure task is CLOSED (renamed to [[wa.completed.2026.2026-07-31_1014-planning-loop-infrastructure]] at wake 2 after the 2026-08-01 dry run: merged PR #30, all D1–D8 ruled, two supervised wakes). First extractor implementation bite (nested sources without root Knops) in flight on `lane/extractor-nested-source`; Stagecraft requirements-collection analysis in flight via codex read-only.
