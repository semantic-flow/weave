...
- **Append-only inventory migration is active and ruled** — add-reference, extracted/current-only MeshInventory, current-only PageDefinition, current-shape extract, and [[wa.completed.2026.2026-08-31_1219-mesh-support-page-only-inventory-append]] are delivered under [[wa.plan.2026.2026-05-17-append-onlyish-inventory]]. Named locator implementation and progression producer/fixture correction are the next cuts; first-Knop append remains behind the latter.
