...
- **Stagecraft IRI initialization is the active coordination plan** — [[wa.plan.2026.2026-08-22_1550-stagecraft-iri-initialization]] sequences the bounded `knop.create` append migration, FoundingReferentData, a 552-entry receipt, and a conditional batch task. The plan stays out of READY; child tasks carry implementation.
