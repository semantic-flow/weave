...
- The planning loop is LIVE and its infrastructure task is CLOSED (renamed to [[wa.completed.2026.2026-07-31_1014-planning-loop-infrastructure]] at wake 2 after the 2026-08-01 dry run: merged PR #30, all D1–D8 ruled). Three implementation PRs await Dave's merge GO: #31 (extractor bite 1 — nested sources without root Knops; fully green), #32 (extractor bite 2 — generator nested-source mode), #33 (planner first-payload bite 1 — untargeted multi-pending batch dispatch). The Stagecraft requirements collection is folded into its note (eleven cited requirements + ownership map); topology stays evidence-gated. [[wa.task.2026.2026-08-01_1411-binary-payload-advancement]] is cut and queue-blocked on the court's five spec adjudications. Append-onlyish carve deferred on harvest capacity.
