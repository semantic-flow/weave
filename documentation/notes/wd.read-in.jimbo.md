...
- **Append-only inventory migration is active** — the oversized legacy task was reclassified as [[wa.plan.2026.2026-05-17-append-onlyish-inventory]] on 2026-08-31 after a fresh writer audit. [[wa.task.2026.2026-08-31_0106-add-reference-inventory-append]] is the first child because `knop add-reference` still canonical-replaces KnopInventory bytes and can discard arbitrary carried facts; MeshInventory weave paths follow, beginning with batched extracted-term weave.
