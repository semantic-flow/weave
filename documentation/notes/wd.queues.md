...
## Kim — implementation
1. [[wa.task.2026.2026-07-21_1603-extractor-defect-pair]] — make extract→weave→generate viable at thousand-term nested-source scale; unblocks the Stagecraft workaround retirement
...
## Jimbo — planning
1. [[wa.task.2026.2026-08-01_2032-regenerate-sflo-published-mesh]] — blocked: needs an SFLO v0.2.1 source release cut first, then the recipe replays from its tag
