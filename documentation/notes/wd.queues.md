...
## Kim — implementation
1. [[wa.task.2026.2026-05-17-append-onlyish-inventory]] — next larger inventory-correctness pick unless a sharper Stagecraft blocker outranks it
2. [[wa.task.2026.2026-08-06_0854-markdown-site-pipeline]] — packaging proof PROVEN; unified pipeline so Markdown artifacts render as pages, below the Stagecraft items
