...
## Kim — implementation
1. [[wa.task.2026.2026-08-31_1639-named-repository-floating-locators]] — implement ruled named floating locators before progression correction
2. [[wa.task.2026.2026-08-06_0854-markdown-site-pipeline]] — packaging proof PROVEN; unified pipeline so Markdown artifacts render as pages
3. [[wa.task.2026.2026-08-31_1111-versioned-first-knop-mesh-inventory-append]] — waits on ruled producer/fixture correction
