...
## Kim — implementation
1. [[wa.task.2026.2026-08-31_1127-current-only-page-definition-inventory-append]] — preserve current-only PageDefinition KnopInventory facts and bytes
...
3. [[wa.task.2026.2026-08-06_0854-markdown-site-pipeline]] — packaging proof PROVEN; unified pipeline so Markdown artifacts render as pages, below the inventory fix
