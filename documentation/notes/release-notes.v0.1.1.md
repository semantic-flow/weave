...
- Added repository-backed source binding support to `integrate`, including repository URL, ref, commit, source path, source binding id, and digest-oriented evidence fields where available.
