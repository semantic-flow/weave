...
- 2026-08-22 — Stagecraft IRI initialization first makes Knop creation additive, then adds locally carried founding data, then measures a 552-IRI press; batch creation ships only if that receipt requires it. → [[wa.plan.2026.2026-08-22_1550-stagecraft-iri-initialization]]
- 2026-08-22 — `knop.create` performance gets a like-for-like 552-create receipt before and after its append/indexing migration, so FoundingReferentData is built on measured behavior rather than a prediction. → [[wa.plan.2026.2026-08-22_1550-stagecraft-iri-initialization]]
- 2026-08-22 — Reset-and-replay repairs founding facts only before a press lands; after publication, correction appends a later artifact state and ships in a new press without rewriting the original. → [[wa.task.2026.2026-08-22_1112-founding-referent-data]]
- 2026-08-22 — Founding corrections use a narrow `weave version` arm: it can version current working data or atomically update-and-version supplied bytes, while the existing payload version API stays payload-only. → [[wa.task.2026.2026-08-22_1112-founding-referent-data]]
- 2026-08-22 — Knop creation now preserves first and later MeshInventory facts with suffix-only semantic proof; the measured slowdown does not trigger batching, and FoundingReferentData runtime work may proceed. → [[wa.plan.2026.2026-08-22_1550-stagecraft-iri-initialization]]
- 2026-08-23 — Stagecraft's measured 552-entry singular founding path is accepted for the v0.9.0 release; batching is ruled off until a future workload or explicit budget justifies a new task. → [[wa.plan.2026.2026-08-22_1550-stagecraft-iri-initialization]], [[wa.plan.2026.2026-08-23_0950-founding-capability-releases]]
