...
- `[importance: high] [how-soon: next]` Continue the carried page-definition ladder now that `16/17`, `18/19`, `20/21`, and `22/23` are real carried pairs: `24/25` should finish root page-customization coverage on the same ladder. See [[wd.task.2026.2026-04-08_1545-resource-page-definition-and-sources]], [[wd.task.2026.2026-04-13_1245-bob-import-boundary-for-page-source]], and [[wd.spec.2026-04-11-identifier-page-customization-and-root-lifecycle]].
