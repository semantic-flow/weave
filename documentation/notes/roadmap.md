...
- `[importance: high] [how-soon: next]` Carry the page-definition runtime and acceptance ladder past the settled `14/15` slice: `16/17` should introduce and weave the governed Markdown artifact used for later page sourcing, `18/19` should prove Alice artifact-backed page sources, `20/21` should prove Bob imported-source behavior from a genuine outside-origin URL, and `22-25` should continue root lifecycle coverage on the same carried ladder. See [[wd.task.2026.2026-04-08_1545-resource-page-definition-and-sources]] and [[wd.spec.2026-04-11-identifier-page-customization-and-root-lifecycle]].
