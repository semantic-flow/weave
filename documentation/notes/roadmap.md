...
- `[importance: high] [how-soon: next]` Treat the carried page-definition ladder through `25-root-page-customized-woven` as settled acceptance coverage and shift the next implementation focus to the first general `import` planner/runtime/CLI surface plus the remaining pinned/fallback page-source semantics. See [[wa.task.2026.2026-04-08_1545-resource-page-definition-and-sources]], [[wa.task.2026.2026-04-13_1245-bob-import-boundary-for-page-source]], and [[sf.spec.2026-04-11-identifier-page-customization-and-root-lifecycle]].
