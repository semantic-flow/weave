...
4. **Append-only inventory migration** — [[wa.plan.2026.2026-05-17-append-onlyish-inventory]]: [[wa.task.2026.2026-08-31_1639-named-repository-floating-locators]] runs serially before progression producer/fixture correction and resumed first-Knop append.
...
- `[importance: medium] [how-soon: next]` Replace remaining inventory rewrites with append-onlyish writes. [[wa.task.2026.2026-08-31_1639-named-repository-floating-locators]] implements the ruled `_sources#payload-source-repository-locator` identity and integrate append path first; progression correction follows.
