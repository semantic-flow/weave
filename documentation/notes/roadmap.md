...
3. **Markdown site pipeline** — [[wa.task.2026.2026-08-06_0854-markdown-site-pipeline]]: ten slices, slice 1 unblocked, packaging proven; the largest new-capability arc, currently queue 2.
4. **Append-only inventory migration** — [[wa.plan.2026.2026-05-17-append-onlyish-inventory]]: named locators and [[wa.completed.2026.2026-08-31_1714-mesh-support-progression-producer-correction]] are delivered; the preserved [[wa.task.2026.2026-08-31_1111-versioned-first-knop-mesh-inventory-append]] WIP resumes against corrected fixtures.
...
- `[importance: medium] [how-soon: next]` Replace remaining inventory rewrites with append-onlyish writes. Named locator identity, integrate append, and corrected mesh-support progression producers/fixtures are delivered; [[wa.task.2026.2026-08-31_1111-versioned-first-knop-mesh-inventory-append]] resumes next.
