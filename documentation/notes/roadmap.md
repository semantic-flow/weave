...
4. **Append-only inventory migration** — [[wa.plan.2026.2026-05-17-append-onlyish-inventory]]: named locators, progression correction, and first-Knop append are delivered; [[wa.task.2026.2026-08-31_1905-versioned-first-payload-mesh-inventory-append]] is the next audited child.
...
- `[importance: medium] [how-soon: next]` Replace remaining inventory rewrites with append-onlyish writes. Named locators, integrate append, corrected mesh-support progression, and first-Knop append are delivered; [[wa.task.2026.2026-08-31_1905-versioned-first-payload-mesh-inventory-append]] migrates the remaining singular/delegated-batch versioned first-payload rewrite next.
