...
- `[importance: medium] [how-soon: next]` Replace remaining inventory rewrites with append-onlyish writes. See [[wa.plan.2026.2026-05-17-append-onlyish-inventory]]; the shared planner and several consumers have shipped, and the first remaining child fixes `knop add-reference` carried-fact loss.
