...
4. **Append-only inventory migration** — [[wa.plan.2026.2026-05-17-append-onlyish-inventory]]: [[wa.completed.2026.2026-08-31_1639-named-repository-floating-locators]] landed the SFLO/Weave contract and integrate append path; [[wa.task.2026.2026-08-31_1714-mesh-support-progression-producer-correction]] is next.
...
- `[importance: medium] [how-soon: next]` Replace remaining inventory rewrites with append-onlyish writes. Named locator identity and integrate append are delivered; [[wa.task.2026.2026-08-31_1714-mesh-support-progression-producer-correction]] now fixes the producer and fixture tails before first-Knop append resumes.
